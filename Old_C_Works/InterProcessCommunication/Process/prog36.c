/* Here, child process trying to modify the pointer value of 'p' whci is global. But parent 
   process doesn't have modified changes. Siince, every process have own variable */
